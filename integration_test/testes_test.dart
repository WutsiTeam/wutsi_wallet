...
Future<void> main() async {
  ...
  group (('WU-84: User enter a valid phone Number'),(){
  testWidgets('WU-84 E1: User enter a valid phone Number ', (tester) async {
  ...
  testWidgets('WU-84 E2: User enter a valid phone Number WU-84 E2', (tester) async {
      app.main();
    await tester.pumpAndSettle();
    await Future.delayed(const Duration(seconds : 5  ));
    var phonefield = find.byType(TextField).first;
  ...
  // group (('WU-109: normal user city exist in drop-down'),(){
  // testWidgets('WU-109 E1:normal user city exist in drop-down', (tester) async {
  ...
  // });
  // });
  // group (('WU-114: The user enter an Incorrect OTP'),(){
  //     testWidgets('WU-114 E1: The user enter an Incorrect OTP',
  ...
  //         });
  //   });
  // group (('WU-113: The user enter a correct OTP and an incorrect PIN'),(){
  //     testWidgets('WU-113 E1:The user enter a correct OTP and an incorrect PIN',
  //             (WidgetTester tester) async {
  //           //setup
  //             app.main();
  //           await tester.pumpAndSettle();
  ...
  //             });
  //   });
  // group (('WU-110: normal user city do not exist in drop-down'),(){
  //     testWidgets('WU-110 E1: normal user city do not exist in drop-down',
  //             (WidgetTester tester) async {
  //           //setup
  //             app.main();
  //           await tester.pumpAndSettle();
  ...
  //         });
  //   });
  // group (('WU-92: User enter a name shorter than 50 characters'),(){
  //     testWidgets('WU-92 E1: User enter a name shorter than 50 characters',
  //             (WidgetTester tester) async {
  //           //setup
  //             app.main();
  //           await tester.pumpAndSettle();
  ...
  //         });
  //   });
  // group (('WU-93: User tries to enter a name longer than 50 characters'),(){
  //   // testWidgets('no sense', (tester) async { await restoreFlutterError(() async {});});
  //   testWidgets('WU-93 E1:User tries to enter a name longer than 50 characters',
  //           (WidgetTester tester) async {
  //         //setup
  //           app.main();
  //         await tester.pumpAndSettle();
  ...
  //       });
  // });
  // group (('WU-94: The user does not fill the Full Name field'),(){
  //   testWidgets('WU-94 E1:The user does not fill the Full Name field',
  //           (WidgetTester tester) async {
  //         //setup
  //           app.main();
  //         await tester.pumpAndSettle();
  ...
  //       });
  // });
  // group (('WU-111: User did not add his city'),(){
  //     testWidgets('WU-111 E1:User did not add his city',
  //             (WidgetTester tester) async {
  //           //setup
  //           app.main();
  //
  ...
  //         });
  //   });
  // group (('WU-91: The user add his valid phone number and enter a wrong validation code E1'),(){
  //     testWidgets('WU-91 E1:The user add his valid phone number and enter a wrong validation code E1',
  //             (WidgetTester tester) async {
  //           //setup
  //             app.main();
  //           await tester.pumpAndSettle();
  ...
  //         });
  //     testWidgets('WU-91 E2:The user add his valid phone number and enter a wrong validation code E2',
  //             (WidgetTester tester) async {
  //           //setup
  //             app.main();
  //           await tester.pumpAndSettle();
  ...
  //           expect (find.text('This field must have at least 6 characters'), findsOneWidget);
  //         });
  //     testWidgets('WU-91 E3: The user add his valid phone number and enter a wrong validation code E3',
  //             (WidgetTester tester) async {
  //           //setup
  //             app.main();
  //           await tester.pumpAndSettle();
  ...
  //           expect (find.text('This field must have at least 6 characters'), findsOneWidget);
  //         });
  //     testWidgets('WU-91 E4: The user add his valid phone number and enter a wrong validation code E4',
  //             (WidgetTester tester) async {
  //           //setup
  //             app.main();
  //           await tester.pumpAndSettle();
  ...
  //           expect (find.text('This field must have at least 6 characters'), findsOneWidget);
  //         });
  //     testWidgets('WU-91 E5:The user add his valid phone number and enter a wrong validation code E5',
  //             (WidgetTester tester) async {
  //           //setup
  //             app.main();
  //           await tester.pumpAndSettle();
  ...
  //         });
  //   });
  // group (('WU-117: The user first NIP does not match to the second NIP '),(){
  //   testWidgets('WU-117 E1: The user first NIP does not match to the second NIP ',
  //           (WidgetTester tester) async {
  //         //setup
  //         app.main();
  //
  ...
  //       });
  // });
  // group (('WU-118: The user modify his NIP'),(){
  //   testWidgets('WU-118 E1: The user modify his NIP',
  //           (WidgetTester tester) async {
  //         //setup
  //         app.main();
  //
  ...
  //       });
  // });
  // group (('WU-116: The user enter the same valid 6 digit NIP twice'),(){
  //   testWidgets('WU-116 E1: The user enter the same valid 6 digit NIP twice',
  //           (WidgetTester tester) async {
  //         //setup
  //         app.main();
  //
  ...
  //       });
  // });
  // group (('WU-112: The user enter a correct OTP and an correct PIN'),(){
  //     testWidgets('WU-112 E1: The user enter a correct OTP and an correct PIN',
  //             (WidgetTester tester) async {
  //           //setup
  //             app.main();
  //           await tester.pumpAndSettle();
